...
func ProvideCommandBus(
	...
	// Note: Using nil for EventStore as it's not implemented yet
	deleteNodeHandler := commands_handlers.NewDeleteNodeHandler(nodeRepo, nil, eventBus, logger)
	...
	// Note: Using nil for EventStore as it's not implemented yet
	bulkDeleteHandler := commands_handlers.NewBulkDeleteNodesHandler(nodeRepo, nil, eventBus, logger)
