// Package observability provides decorator implementations for repository interfaces.
...
func (r *LoggingNodeRepository) FindNodeByID(ctx context.Context, userID, nodeID string) (*node.Node, error) {
	start := time.Now()
	operationID := generateOperationID()
...
func (r *LoggingNodeRepository) FindNodes(ctx context.Context, query repository.NodeQuery) ([]*node.Node, error) {
	start := time.Now()
	operationID := generateOperationID()
...
func (r *LoggingNodeRepository) GetNodeNeighborhood(ctx context.Context, userID, nodeID string, depth int) (*shared.Graph, error) {
	start := time.Now()
	operationID := generateOperationID()
...
func (r *LoggingEdgeRepository) CreateEdge(ctx context.Context, edge *edge.Edge) error {
	start := time.Now()
	operationID := generateOperationID()
...
func (r *LoggingEdgeRepository) FindEdges(ctx context.Context, query repository.EdgeQuery) ([]*edge.Edge, error) {
	start := time.Now()
	operationID := generateOperationID()
...
func (r *LoggingNodeRepository) FindNodesWithOptions(ctx context.Context, query repository.NodeQuery, opts ...repository.QueryOption) ([]*node.Node, error) {
	if r.config.LogRequests {
...
func (r *LoggingEdgeRepository) FindEdgesWithOptions(ctx context.Context, query repository.EdgeQuery, opts ...repository.QueryOption) ([]*edge.Edge, error) {
	if r.config.LogRequests {
