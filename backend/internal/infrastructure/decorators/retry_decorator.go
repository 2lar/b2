// Package decorators - Retry decorator for resilient repository operations.
package decorators
...
func (r *RetryNodeRepository) CreateNodeAndKeywords(ctx context.Context, node *domain.Node) error {
...
func (r *RetryNodeRepository) FindNodeByID(ctx context.Context, userID, nodeID string) (*domain.Node, error) {
...
func (r *RetryNodeRepository) FindNodes(ctx context.Context, query repository.NodeQuery) ([]*domain.Node, error) {
	var result []*domain.Node
...
func (r *RetryNodeRepository) GetNodeNeighborhood(ctx context.Context, userID, nodeID string, depth int) (*domain.Graph, error) {
	var result *domain.Graph
...
func (r *RetryNodeRepository) FindNodesWithOptions(ctx context.Context, query repository.NodeQuery, opts ...repository.QueryOption) ([]*domain.Node, error) {
	var result []*domain.Node
...
func (r *RetryEdgeRepository) CreateEdge(ctx context.Context, edge *domain.Edge) error {
...
func (r *RetryEdgeRepository) FindEdges(ctx context.Context, query repository.EdgeQuery) ([]*domain.Edge, error) {
...
func (r *RetryEdgeRepository) FindEdgesWithOptions(ctx context.Context, query repository.EdgeQuery, opts ...repository.QueryOption) ([]*domain.Edge, error) {
	var result []*domain.Edge
