...
func (r *CachingNodeRepository) marshalNode(node *domain.Node) ([]byte, error) {
...
func (r *CachingNodeRepository) unmarshalNode(data []byte) (*domain.Node, error) {
...
func (r *CachingNodeRepository) marshalNodeSlice(nodes []*domain.Node) ([]byte, error) {
...
func (r *CachingNodeRepository) unmarshalNodeSlice(data []byte) ([]*domain.Node, error) {
	var serializable []map[string]interface{}
	if err := json.Unmarshal(data, &serializable); err != nil {
		return nil, err
	}
	
	nodes := make([]*domain.Node, len(serializable))
...
func (r *CachingNodeRepository) marshalGraph(graph *domain.Graph) ([]byte, error) {
	return json.Marshal(graph)
}

func (r *CachingNodeRepository) unmarshalGraph(data []byte) (*domain.Graph, error) {
