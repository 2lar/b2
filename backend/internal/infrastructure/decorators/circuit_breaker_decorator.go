// Package decorators - Circuit Breaker decorator for preventing cascading failures.
package decorators
...
func (r *CircuitBreakerNodeRepository) CreateNodeAndKeywords(ctx context.Context, node *domain.Node) error {
...
func (r *CircuitBreakerNodeRepository) FindNodeByID(ctx context.Context, userID, nodeID string) (*domain.Node, error) {
...
func (r *CircuitBreakerNodeRepository) FindNodes(ctx context.Context, query repository.NodeQuery) ([]*domain.Node, error) {
	var result []*domain.Node
	err := r.circuitBreaker.Execute(func() error {
		var err error
...
func (r *CircuitBreakerNodeRepository) GetNodeNeighborhood(ctx context.Context, userID, nodeID string, depth int) (*domain.Graph, error) {
...
func (r *CircuitBreakerNodeRepository) FindNodesWithOptions(ctx context.Context, query repository.NodeQuery, opts ...repository.QueryOption) ([]*domain.Node, error) {
	var result []*domain.Node
	err := r.circuitBreaker.Execute(func() error {
		var err error
