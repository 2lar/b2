...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/nodes/{nodeId}/connections": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "description": "Connection request with target node ID",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/brain2-backend_pkg_api.ConnectNodesRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "$ref": "#/definitions/brain2-backend_pkg_api.ConnectionResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request or nodes",
                        "schema": {
                            "$ref": "#/definitions/brain2-backend_pkg_api.ErrorResponse"
                        }
                    },
        ...
        "/nodes/{nodeId}/connections/{targetNodeId}": {
            "delete": {
                "security": [
                    {
                        "Bearer": []
    ...
    "definitions": {
        ...
        "brain2-backend_pkg_api.ConnectNodesRequest": {
            "type": "object",
            "required": [
                "targetNodeId"
            ],
            "properties": {
                "targetNodeId": {
                    "description": "TargetNodeID is the ID of the node to connect to",
                    "type": "string",
                    "example": "node-456"
                }
            }
        },
        "brain2-backend_pkg_api.ConnectionResponse": {
            "type": "object",
            "properties": {
                "edgeId": {
                    "description": "EdgeID is the unique identifier for the created edge",
                    "type": "string",
                    "example": "node-123-node-456"
                },
                "message": {
                    "description": "Message provides a human-readable confirmation",
                    "type": "string",
                    "example": "Nodes connected successfully"
                }
            }
        },
